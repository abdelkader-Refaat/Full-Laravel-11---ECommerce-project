        ...
        <form action="{{route('categories.update',$category->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" value="{{$category->getTranslation('name','ar')}}" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar">
                    </div>
                    @error('name_ar')
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3 col">
                        <input type="text" value="{{$category->getTranslation('name','en')}}"  class="form-control @error('name_en') is-invalid @enderror" name="name_en">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" value="{{$category->slug}}"  class="form-control  @error('slug') is-invalid @enderror" name="slug">
                    </div>
                    @error('slug')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3 col">
                        <img class="rounded-full w-10 h-10" src="{{Storage::url($category->image)}}" alt="">
                        <input type="file" value="{{$category->image}}" class="form-control  @error('image') is-invalid @enderror" name="image">
                    </div>
                    @error('image')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input type="checkbox" {{($category->is_showing == 1) ? 'checked':'' }} class="" id="is_showing" name="is_showing">
                    </div>
                </div>
                <div class="col">
                    <label class="ml-3 " for="is_popular">{{trans('category.is_popular')}}</label>
                    <div class="input-group mb-3 col">
                        <input type="checkbox" {{($category->is_popular == 1)? 'checked':'' }} id="is_popular" name="is_popular">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <button  type="submit" class="btn btn-outline-primary flex justify-center">{{trans('category.update')}}</button>
        </form>
    </div>
