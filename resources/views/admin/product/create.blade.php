...
@section('title')
    <span class="text-danger">{{trans('product.add')}}</span>
  @endsection
         ...
         <form action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input type="checkbox" class="" id="is_showing" name="status">
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3 col">
                        <input type="checkbox" class="" id="is_popular" name="trend">
                    </div>
                </div>
            </div>
            <div class="row">
           ...
           <div class="flex flex-col items-center mb-2"> <button  type="submit" class="btn btn-outline-primary">{{trans('product.savebutton')}}</button></div>
        </form>
    </div>
